...
<head>
    ...
    <link rel="stylesheet" href="/CRM/salesManagement/css/ManageSaleOpportunity.css">
                    ...
                    $.get("/CRM/sales/salesfind.action",{cusName:b1,outLine:b2, linkName:b3}, function (data) {
                        ...
                        $(data).each(function (i, obj) {
                            ...
                            var td = "<td>" + obj.salesId + "</td>" +
                                ...
                                "<td>" + date + "</td>" +
                                "<td> " +
                                "<a href='/CRM/plan/plandoPlanFind.action?salesId="+obj.salesId+"'><i title='执行计划' class='layui-icon'>&#xe610;</i></a>" +
                                "<a href='/CRM/plan/plandrawPlanFind.action?salesId="+obj.salesId+"'><i title='制定计划' class='layui-icon'>&#xe642;</i></a>" +
...
//                        ,content: '<img src="../images/help_cusManage.png" >'
                    ,content: '<div style="padding: 20px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;"><img src="../images/CustDist.png" ></div>'
...
<div class="admin-main">
    <div id="main">
        ...
        <div class="layui-btn-group">
            <a href="CustDist.jsp" ><button class="layui-btn">刷新</button></a>
                        ...
                        $.get("${pageContext.request.contextPath}/sales/salespage.action", {currentPageNo: curr}, function (data) {
                            ...
                            $(data.data).each(function (i, obj) {
                                ...
                                var userId=$("#userId").val();
                                 ...
                                 var   operation="<a href='/CRM/plan/plandoPlanFind.action?salesId="+obj.salesId+"'><i title='执行计划' class='layui-icon'>&#xe610;</i></a>" +
                                            "<a href='/CRM/plan/plandrawPlanFind.action?salesId="+obj.salesId+"'><i title='制定计划' class='layui-icon'>&#xe642;</i></a>" +
                                            "<a href='#' onclick='del(this)' ><i title='删除' class='layui-icon'>&#x1006;</i></a>"
