...
import com.chinasofti.crm.biz.impl.MySqlBizImpl;
...
public class FristScheduledJob extends QuartzJobBean {
    ...
    public void setMySqlBiz(MySqlBizImpl mySqlBiz) {
        this.mySqlBiz = mySqlBiz;
    }

    public MySqlBizImpl getMySqlBiz() {
        return mySqlBiz;
    }
}
