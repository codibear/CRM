...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/serviceManagement/css/serviceFeedback.css" />
</head>
<body>
<div id="main">
    <div>
        <span style="color: black;">客户服务管理 ></span>
        <span style="color: black;">服务反馈</span>
    </div>
    <form class="layui-form">
        ...
        <table class="layui-table">
            <tr>
                ...
                <td>服务类型</td>
                <td>
                <select id="serviceType" name="service.serviceType" style="display: block">
...
<script>
    ...
    $(function () {
        $("#find").click(function () {
            ...
            var curr =1 ;
            $.get("${pageContext.request.contextPath}/service/servicepage.action",{currentPageNo:curr,serviceId:serviceId,cusName:cusName,serviceType:serviceType,serviceState:"已处理",managerId:"${user.userId}"},function (data) {
                ch(data.data) ;
    ...
    function ch(data) {
        ...
        $(data).each(function(i,obj){
            var td =
                ...
                "<td  style='width: 90px'>"+'<a href="<%=request.getContextPath()%>/service/serviceloadbyid2.action?serviceId='+obj.serviceId+'"'+ 'class="layui-btn layui-btn-primary layui-btn-small">'+'<i class="layui-icon" title="编辑">&#xe642;</i>'+"</a>";
            tr = tr + td + "</tr>"
        });
        $("#message").append(tr) ;
    }
    ...
    function  help() {
        ...
        layer.open({
            ...
            content: '<div style="padding: 20px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;"><img src="<%=request.getContextPath()%>/images/serviceFeedback.png" style="width:620px;height:350px"></div>',
